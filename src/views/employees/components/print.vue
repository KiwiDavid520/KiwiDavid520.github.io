<template>
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      ...
      <el-card>
        <el-row type="flex" justify="end" style="padding:0px 50px">
          <el-col :span="1">
            <el-row>
              <el-button class="printInfo" @click="printInfo">打印</el-button>
            </el-row>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    async getJobDetail() {
      const userInfo = await getDetailInfo(this.userId)
